...
async function seedDatabase() {
    try {
        ...
        // Seed Teams
        const team1 = await Team_1.default.create({ name: 'Fitness Ninjas' });
        const team2 = await Team_1.default.create({ name: 'Cardio Kings' });
        const team3 = await Team_1.default.create({ name: 'Strength Squad' });
        ...
        await Team_1.default.updateOne({ _id: team1._id }, { members: [users[0]._id, users[1]._id] });
        await Team_1.default.updateOne({ _id: team2._id }, { members: [users[2]._id, users[3]._id] });
        await Team_1.default.updateOne({ _id: team3._id }, { members: [users[4]._id, users[5]._id] });
        ...
        // Seed Leaderboard
        const leaderboards = await Leaderboard_1.default.create([
